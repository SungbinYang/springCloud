package me.sungbin.resilience4j.service;
...
public class BulkHeadController {
    ...
    public BulkHeadController(RestTemplate restTemplate, @Value("${apiServer.url}") String provideUrl, @Value("${apiServer.maxConcurrent}") int maxConcurrent) {
